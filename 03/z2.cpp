...
void zad2_1(double n, double y11, double y21, double S, double T, double tol, char* file)
{
    ...
    for(double t = 0; t < T;){
        ...
        y11 = trapez(prevy1, prevy1, prevy2, t, dt * 2, func1);
        y12 = trapez(prevy1, prevy1, prevy2, t, dt, func1);
        y12 = trapez(y12, y12, prevy2, t, dt, func1);

        y21 = trapez(prevy2, prevy1, prevy2, t, dt * 2, func2);
        y22 = trapez(prevy2, prevy1, prevy2, t, dt, func2);
        y22 = trapez(y22, prevy1, y22, t, dt, func2);
